...
//    @Environment(\.managedObjectContext) var context //Para uso de core data
...
//    @FetchRequest( //Para uso con core data
//        entity: Producto.entity(),
//        sortDescriptors: [NSSortDescriptor(keyPath: \Producto.dateAdded, ascending: false)] //Ordenar
//        //predicate: NSPredicate(format: "isComplete == %@", NSNumber(value: false)) //Para filtrar
//    ) var ListaDeProductosSeguidos: FetchedResults<Producto>

    
    var body : some View{

        List{
            //For hecho para el metodo anterior de almacenar los productos
            ...
            //For Nuevo usando core data
//            ForEach(ListaDeProductosSeguidos){ producto in
//                //ProductRow(Productox: producto)
//                Text("adf")
//            }
